...
!                                                                       
      MODULE PARAMS 
        ...
        REAL (DP), ALLOCATABLE::DRWDT(:)		!MT 24102017
        INTEGER (I4B) :: NESP 
...
! ************************** CHENGJI 2013-09-02 **************************
	  MODULE CJCONTRL  
		 USE SutraMSPrecision
	     REAL (DP), ALLOCATABLE::GNUPCJ(:)
	  END MODULE CJCONTRL 

      MODULE M_TIDE
         IMPLICIT NONE
         DOUBLE PRECISION :: TASP,TANE,TPSP,TPNP,TM,RHOST,SC,BNDSWT,FWT,FWH    !MT - 04112017 - ADD SWT
      END MODULE M_TIDE
      
!    WATER RETENTION PARAMETERS USED AT UNSAT
      MODULE M_SWCC
         IMPLICIT NONE
         DOUBLE PRECISION :: SWRES1,AA1,VN1,SWRES2,AA2,VN2
      END MODULE M_SWCC
      
      MODULE M_CONTROL
         IMPLICIT NONE
         DOUBLE PRECISION :: AVGVEL,TLAB,AMP
         INTEGER          :: HOMO,NSTEP
      END MODULE M_CONTROL
      
      MODULE M_SEEPAGE
         IMPLICIT NONE
         DOUBLE PRECISION :: SEEP,XSTART,ZSTART
      END MODULE M_SEEPAGE
 !************************************************************************
 ! ************************** !MT - 04112017 *****************************
       MODULE M_SEASONALT
         IMPLICIT NONE
         DOUBLE PRECISION :: SST5,SST4,SST3,SST2,SST1,SST0,TIMTH
      END MODULE M_SEASONALT
 !************************************************************************